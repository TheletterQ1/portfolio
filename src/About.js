...
const About = () => (
  <div>
    ...
    <p>
      ...
      trainer all wraped into a big bundle of me.(3 for 1, its a good deal).Located in sunny Los Angeles, California where
    ...
    <div id="project-holder">
      <div className="project-details">
        ...
        <a id='demo' href='https://pause-app.netlify.app/'>See the live demo </a>
      </div>
      <div className="project-details">
